...
require __DIR__ . '/src/Reducing/p_first_key_or.php';
require __DIR__ . '/src/Reducing/p_first_or.php';
...
require __DIR__ . '/src/Reducing/p_last_key_or.php';
require __DIR__ . '/src/Reducing/p_last_or.php';
