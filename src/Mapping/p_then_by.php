...
/**
 * Returns a partial function that can be chained to `p_order_by` or `p_order_by_preserving_keys`, to provide tie-breakers. Multiple `p_then_by` calls
 ...
 *
 * Key preservation is dictated by the `p_order_by` or `p_order_by_preserving_keys` function and propagated to the entire chain.
 *
 * ### Syntax
 * ```
 * p_then_by(
